...
expName = 'visual search experiments'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Sandeep\\OneDrive\\Desktop\\lab in psychology\\visual search experiments_lastrun.py',
